...
<img class="mySlides w3-animate-top" src="img/dj.png" style="width:100%" height="300px">
<img class="mySlides w3-animate-top" src="img/mixer1.jpg" style="width:100%" height="300px">
<img class="mySlides w3-animate-top" src="img/mixer2.jpg" style="width:100%" height="300px">
...
<br />
<center>
<font color="black"><h1><b>

Entertain your guests with sounds</b></h1></font>

</center>
<br />

<center><fieldset><legend><font color="green"><b>BOOK DJ</b></font></legend>
		
		
		<form name="wed" action=MAILTO:"DARLINGTONEKENNA@GMAIL.COM" enctype="multipart/form-data" method="POST">
		
		<label><font color="lime">Full name: </font></label>
		<input type="text" name="txt" value="" required><br />
		<br /><label><font color="lime">Address: </font></label>
		<input type="text" name="ad" value="" required><br />
		
		<br /><label><font color="lime">Phone No: </font></label>
		<input type="number" name="ad" value="" required><br />
		
		<br /><label><font color="lime">Date/Time: </font></label>
		<input type="text" name="ad" value="" required><br />
		
		<br /><input type="submit" name="btn" value="BOOK YOUR DJ" 
