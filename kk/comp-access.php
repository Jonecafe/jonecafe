	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar1">
			...
			<li><form method="post" class="form-wrapper " id="search" action="Service/Search">
                            <input id="search_input" type="text" required="required" class="search" name="searchString" placeholder="Search services, options and payment codes"/>
...
<br /><font color="black"><h2><b>QUALITY COMPUTER ACCESSORIES AVAILABLE.</b></font> <font color="red"><i>10% discount</i></font></h2><br />
<br />
