	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar1">
			...
			<li><form method="post" class="form-wrapper " id="search" action="Service/Search">
				...
				<li><a href="contact.php"><button class="con"><font color="black" title="Check your waec">Waec result</font></button id="con"></a></li>
			<li><a href="contact.php"><button class="con"><font color="black" title="Advertize with us">Advertize</font></button id="con"></a></li>
		<li><a href="contact.php"><button class="con"><font color="black" title="Contact us">Contact us</font></button id="con"></a></li>
				...
				<li><a href="twitter.com/chibscoweb"><img height="30px" width="30px" src="img/li.png"></img></a></li>
			</ul>
		</div>
	</div>
</nav>
...
<img class="mySlides w3-animate-top" src="img/a.jpg" style="width:100%">
<img class="mySlides w3-animate-bottom" src="img/b.jpg" style="width:100%">
<img class="mySlides w3-animate-top" src="img/c.jpg" style="width:100%">
<img class="mySlides w3-animate-bottom" src="img/d.jpg" style="width:100%">
<img class="mySlides w3-animate-top" src="img/e.jpg" style="width:100%">
<img class="mySlides w3-animate-bottom" src="img/f.jpg" style="width:100%">
<img class="mySlides w3-animate-top" src="img/g.jpg" style="width:100%">
<img class="mySlides w3-animate-bottom" src="img/h.jpg" style="width:100%">

</div></center>
<br />
<br />

<font color="lime"><marquee width="500px" type="relative" bgcolor="black"><blink>Welcome to JONECAFE. This is your trusted platform for your buying and selling of goods.</blink></marquee></font>
