...
echo "<span style='float:left;color:blue;hover:color:red'><b>JONECCAFE</b></span>";	
	
echo "<span style='background-color:lime;border-radius:20px;color:white;padding:12px;margin:6px'><b>The file ".basename($_FILES['fileToUpload']['name']). " has been uploaded.</b></span>";
 
}
else{
	echo "<span style='background-color:red;border-radius:20px;color:white;padding:12px;margin:6px'><b>Sorry, there was a problem uploading your file.</b></span>";
}
?></div></b></center>
